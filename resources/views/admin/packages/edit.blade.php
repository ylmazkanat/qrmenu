...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Paket Düzenle: {{ $package->name }}</h1>
            ...
            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('billing_cycle') is-invalid @enderror" 
                                        ...
                                        <option value="monthly" {{ old('billing_cycle', $package->billing_cycle) == 'monthly' ? 'selected' : '' }}>Aylık</option>
                                        <option value="yearly" {{ old('billing_cycle', $package->billing_cycle) == 'yearly' ? 'selected' : '' }}>Yıllık</option>
                                    </select>
                                    @error('billing_cycle')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="feature_max_restaurants" 
                                           name="feature_max_restaurants" 
                                           value="{{ old('feature_max_restaurants', $features->get('max_restaurants') ? $features->get('max_restaurants')->limit_value : 0) }}" min="0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="feature_max_managers" 
                                           name="feature_max_managers" 
                                           value="{{ old('feature_max_managers', $features->get('max_managers') ? $features->get('max_managers')->limit_value : 0) }}" min="0">
                                    <small class="form-text text-muted">0 = Sınırsız</small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="feature_max_staff" 
                                           name="feature_max_staff" 
                                           value="{{ old('feature_max_staff', $features->get('max_staff') ? $features->get('max_staff')->limit_value : 0) }}" min="0">
                                    <small class="form-text text-muted">0 = Sınırsız</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @php
                                $features = $features->keyBy('feature_key');
                            @endphp
                            @foreach($predefinedFeatures as $key => $feature)
                                @if($feature['type'] == 'boolean')
                                    @php
                                        $featureModel = $features->get($key);
                                        $isEnabled = $featureModel ? $featureModel->is_enabled : false;
                                    @endphp
                                    <div class="col-md-6">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" 
                                                   id="feature_{{ $key }}" name="feature_{{ $key }}" 
                                                   {{ old("feature_{$key}", $isEnabled) ? 'checked' : '' }}>
            ...
            <div class="col-md-4">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.packages.index') }}" class="btn btn-secondary btn-block mt-2">İptal</a>
                    </div>
                </div>
            </div>
        </div>
